...
public class Supplier implements Serializable {
    ...
    @XmlElement(name = "HomePage", required = true, nillable = true)
    ...
    public boolean equals(Object obj) {
        ...
        if (this.supplierID.equals(sup.supplierID)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hash = 5;
        hash = 47 * hash + (this.supplierID != null ? this.supplierID.hashCode() : 0);
        return hash;
    }       
    ...
    public boolean isValidate(){
    	if (this.companyName == null || this.companyName.equals("")
    		...
    		|| (this.contactName != null && this.contactName.length() > 30)
    		|| (this.contactTitle != null && this.contactTitle.length() > 30)
    		|| (this.address != null && this.address.length() > 60)
    		|| (this.city != null && this.city.length() > 15)
    		|| (this.region != null && this.region.length() > 15)
    		|| (this.postalCode != null && this.postalCode.length() > 10)
    		|| (this.country != null && this.country.length() > 15)
    		|| (this.phone != null && this.phone.length() > 24)
    		|| (this.fax != null && this.fax.length() > 24)
    			){
    		return false;
    	}
    	return true;
